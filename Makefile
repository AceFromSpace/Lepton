...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Nov 15 07:35:50 2016
# Project:  raspberrypi_video.pro
# Template: app
# Command: /usr/lib/arm-linux-gnueabihf/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile raspberrypi_video.pro
#############################################################################
...
INCPATH       = -I/usr/share/qt4/mkspecs/linux-g++ -I. -I/usr/include/qt4/QtCore -I/usr/include/qt4/QtGui -I/usr/include/qt4 -I. -I../raspberrypi_libs -Ipkg-config\ --libs\ opencv -I`pkg-config -I--cflags -Iopencv` -Igen_mocs
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/arm-linux-gnueabihf -L../raspberrypi_libs/leptonSDKEmb32PUB/Debug -lLEPTON_SDK `pkg-config --libs opencv` -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
OBJECTS       = gen_objs/Lepton_I2C.o \
		...
		gen_objs/main.o \
		gen_objs/MyLabel.o \
		gen_objs/newwindow.o \
		gen_objs/Palettes.o \
		gen_objs/Recognizer.o \
		gen_objs/SPI.o \
...
Makefile: raspberrypi_video.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile raspberrypi_video.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents Lepton_I2C.h LeptonThread.h MyLabel.h newwindow.h Palettes.h Recognizer.h SPI.h ui_game.h gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents Lepton_I2C.cpp LeptonThread.cpp main.cpp MyLabel.cpp newwindow.cpp Palettes.cpp Recognizer.cpp SPI.cpp gen_objs/raspberrypi_video1.0.0/ && (cd `dirname gen_objs/raspberrypi_video1.0.0` && $(TAR) raspberrypi_video1.0.0.tar raspberrypi_video1.0.0 && $(COMPRESS) raspberrypi_video1.0.0.tar) && $(MOVE) `dirname gen_objs/raspberrypi_video1.0.0`/raspberrypi_video1.0.0.tar.gz . && $(DEL_FILE) -r gen_objs/raspberrypi_video1.0.0
...
gen_objs/newwindow.o: newwindow.cpp newwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gen_objs/newwindow.o newwindow.cpp

gen_objs/Palettes.o: Palettes.cpp Palettes.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gen_objs/Palettes.o Palettes.cpp

gen_objs/Recognizer.o: Recognizer.cpp Recognizer.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o gen_objs/Recognizer.o Recognizer.cpp
