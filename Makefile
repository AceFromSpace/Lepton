...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Nov 9 15:24:10 2016
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents Lepton_I2C.h LeptonThread.h MyLabel.h Palettes.h Recognizer.h SPI.h gen_objs/raspberrypi_video1.0.0/ && $(COPY_FILE) --parents Lepton_I2C.cpp LeptonThread.cpp main.cpp MyLabel.cpp Palettes.cpp Recognizer.cpp SPI.cpp gen_objs/raspberrypi_video1.0.0/ && (cd `dirname gen_objs/raspberrypi_video1.0.0` && $(TAR) raspberrypi_video1.0.0.tar raspberrypi_video1.0.0 && $(COMPRESS) raspberrypi_video1.0.0.tar) && $(MOVE) `dirname gen_objs/raspberrypi_video1.0.0`/raspberrypi_video1.0.0.tar.gz . && $(DEL_FILE) -r gen_objs/raspberrypi_video1.0.0
